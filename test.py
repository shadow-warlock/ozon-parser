...
for element in recommends:
    name = element.find_element_by_css_selector('div:nth-child(3)').get_property("textContent")
    score = element.find_element_by_css_selector('div:nth-child(4)').get_attribute('title')
    price = element.find_element_by_css_selector('div:nth-child(2)>div:nth-child(1)>span>span>span').get_property("textContent")
